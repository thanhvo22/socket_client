...
describe('Intl.RelativeTimeFormat', function () {
  ...
  it('should use quantify for a language of a specific locale', function () {
    ...
    new _RelativeTimeFormat["default"]("ar-AE").format(-3, "year").should.equal("قبل ٣ سنوات");
    new _RelativeTimeFormat["default"]("ar-AE").format(-1.23, "year").should.equal("قبل ١٫٢٣ سنة");
  });
